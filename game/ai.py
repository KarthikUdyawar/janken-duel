...
class AI:
    def __init__(self, difficulty: str = "medium") -> None:
        ...
        self.move_exploit: dict[str, float] = {
            "easy": 0.0,
            "medium": 0.7,
            "hard": 0.9,
        }
        self.dir_exploit: dict[str, float] = {
            "easy": 0.0,
            "medium": 0.65,
            "hard": 0.85,
        }
    ...
    def record_player_move(self, move: Move) -> None:
    ...
    def record_player_dir(self, direction: Direction) -> None:
